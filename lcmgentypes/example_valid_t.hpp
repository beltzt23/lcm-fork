...
#ifndef __lcmgentypes_example_valid_t_hpp__
#define __lcmgentypes_example_valid_t_hpp__
...
namespace lcmgentypes
{

class example_valid_t
{
    public:
        int64_t    timestamp;
...
int example_valid_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int example_valid_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int example_valid_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t example_valid_t::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* example_valid_t::getTypeName()
{
    return "example_valid_t";
}

int example_valid_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int example_valid_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int example_valid_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t example_valid_t::_computeHash(const __lcm_hash_ptr *)
{
