...
public final class example_valid_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(lcmgentypes.example_valid_t.class))
            return 0L;
 
        classes.add(lcmgentypes.example_valid_t.class);
    ...
    public example_valid_t(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public example_valid_t(DataInput ins) throws IOException
    {
    ...
    public static lcmgentypes.example_valid_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        lcmgentypes.example_valid_t o = new lcmgentypes.example_valid_t();
    ...
    public lcmgentypes.example_valid_t copy()
    {
        lcmgentypes.example_valid_t outobj = new lcmgentypes.example_valid_t();
