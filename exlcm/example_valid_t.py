...
class example_valid_t(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(example_valid_t._get_packed_fingerprint())
    ...
    def decode(data: bytes):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != example_valid_t._get_packed_fingerprint():
            raise ValueError("Decode error")
        return example_valid_t._decode_one(buf)

    @staticmethod
    def _decode_one(buf):
        self = example_valid_t()
    ...
    def _get_hash_recursive(parents):
        if example_valid_t in parents: return 0
    ...
    def _get_packed_fingerprint():
        if example_valid_t._packed_fingerprint is None:
            example_valid_t._packed_fingerprint = struct.pack(">Q", example_valid_t._get_hash_recursive([]))
        return example_valid_t._packed_fingerprint

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", example_valid_t._get_packed_fingerprint())[0]
