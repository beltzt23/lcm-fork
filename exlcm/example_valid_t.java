...
public final class example_valid_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(exlcm.example_valid_t.class))
            return 0L;
 
        classes.add(exlcm.example_valid_t.class);
    ...
    public static exlcm.example_valid_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        exlcm.example_valid_t o = new exlcm.example_valid_t();
    ...
    public exlcm.example_valid_t copy()
    {
        exlcm.example_valid_t outobj = new exlcm.example_valid_t();
