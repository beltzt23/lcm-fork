...
public final class example_valid_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(lcmtypes.example_valid_t.class))
            return 0L;
 
        classes.add(lcmtypes.example_valid_t.class);
    ...
    public static lcmtypes.example_valid_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        lcmtypes.example_valid_t o = new lcmtypes.example_valid_t();
    ...
    public lcmtypes.example_valid_t copy()
    {
        lcmtypes.example_valid_t outobj = new lcmtypes.example_valid_t();
